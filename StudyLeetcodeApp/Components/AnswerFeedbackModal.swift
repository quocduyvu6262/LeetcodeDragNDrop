...
struct AnswerFeedbackModal: View {
  ...
  private func feedbackMessage(when isCorrect: Bool, for _: String) -> String {
    switch isCorrect {
    case true:
      "Great job! Your solution is correct."
    case false:
      "Oops! Check your solution again."
    }
  }
}

struct AnswerFeedbackModalPreview: View {
